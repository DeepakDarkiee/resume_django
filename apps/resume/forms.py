    ...
    class Meta:
        ...
        widgets = {
            'full_name': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'full name', 'name': 'fname', 'id': 'fname'}),

            'email': forms.EmailInput(
                attrs={'class': 'form-control', 'placeholder': 'email', 'name': 'email', 'id': 'email'}),
        }
    ...
    class Meta:
        ...
        widgets = {
            'title': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'title', 'name': 'title', 'id': 'title'}),
            'objective': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'objective', 'name': 'objective', 'id': 'objective'}),
        }
    ...
    class Meta:
        ...
        widgets = {
            'skills': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Your skills ', 'skills': 'Name', 'id': 'skills'}),
        }
        fields = ['skills']
    ...
    class Meta:
        ...
        widgets = {
            'hobbies': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Your Hobbies', 'name': 'hobbies', 'id': 'hobbies'}),
        }
        fields = ['hobbies']
    ...
    class Meta:
        ...
        widgets = {
            'certificate': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Certificate', 'name': 'certificate',
                       'id': 'certificate'}),
        }
        fields = ['certificate']
...
class AchievementsForm(forms.ModelForm):
    class Meta:
        model = Achievements
        widgets = {
            'achievements': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Achievements', 'name': 'achievements',
                       'id': 'achievements'}),
        }
        fields = ['achievements']
    ...
    class Meta:
        ...
        widgets = {
            'first_name': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'first name', 'name': 'fname', 'id': 'fname'}),
            'last_name': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'last name', 'name': 'lname', 'id': 'lname'}),
            'email': forms.EmailInput(
                attrs={'class': 'form-control', 'placeholder': 'email', 'name': 'email', 'id': 'email'}),
        }
